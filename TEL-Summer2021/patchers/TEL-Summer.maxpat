...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 480.0, 64.0, 150.0, 150.0 ],
					"presentation" : 1,
					"presentation_linecount" : 7,
					"presentation_rect" : [ 299.990127999999913, 26.0, 192.0, 122.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 199.0, 640.5, 139.0, 79.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 471.0, 501.0, 248.0, 94.0 ],
					"presentation" : 1,
					"presentation_linecount" : 6,
					"presentation_rect" : [ 730.5, 6.5, 182.0, 108.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 30.0, 640.5, 154.0, 81.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 480.0, 57.0, 150.0, 177.0 ],
					"presentation" : 1,
					"presentation_linecount" : 9,
					"presentation_rect" : [ 44.323441000000003, 6.5, 191.0, 150.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1104.0, 1084.0, 403.0, 196.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 30.0, 419.0, 403.0, 196.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1404.0, 253.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1077.0, 223.0, 50.0, 36.0 ],
					"text" : "31.869386"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1218.838279499999771, 271.0, 42.0, 22.0 ],
					"text" : "thresh"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1189.0, 211.0, 49.0, 22.0 ],
					"text" : "Uzi 128"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1218.838279499999771, 236.5, 147.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1108.0, 578.5, 178.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 949.0, 402.5, 214.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 949.0, 433.5, 215.0, 22.0 ],
					"text" : "jit.spill"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1229.0, 331.5, 57.0, 22.0 ],
					"text" : "dim $1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 949.0, 300.5, 215.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 949.0, 336.5, 215.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 949.0, 188.000061000000017, 63.0, 22.0 ],
					"text" : "change 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 949.0, 227.0, 63.0, 22.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 949.0, 262.5, 63.0, 22.0 ],
					"text" : "zl.rot"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 949.0, 141.0, 101.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1385.333333333333258, 508.0, 40.0, 22.0 ],
					"text" : "* 127."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1385.333333333333258, 477.0, 41.0, 22.0 ],
					"text" : "abs 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1606.0, 734.0, 59.0, 22.0 ],
					"text" : "scramble"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1565.0, 734.0, 29.5, 22.0 ],
					"text" : "rev"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1526.0, 734.0, 31.0, 22.0 ],
					"text" : "sort"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1385.333333333333258, 734.0, 41.0, 22.0 ],
					"text" : "/ 127."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1385.333333333333258, 537.5, 41.0, 187.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 1104.0, 1300.0, 152.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1104.0, 775.0, 441.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1104.0, 811.5, 207.676558999999997, 231.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 299.990127999999913, 150.0, 204.676558999999997, 246.5 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "", "", "", "" ],
					"patching_rect" : [ 1097.400000000000091, 80.5, 203.0, 102.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 274.0, 1538.0, 77.714285714285722, 77.714285714285722 ],
					"presentation" : 1,
					"presentation_rect" : [ 351.285714285714221, 640.5, 77.714285714285722, 77.714285714285722 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 274.0, 882.0, 430.0, 643.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1369.0, 306.5, 150.0, 22.0 ]
				}
...
, 			{
				"name" : "sc.scala.maxpat",
				"bootpath" : "Z:/Documents/Max 8/Packages/SC/patchers/sound/sc.scala",
				"patcherrelativepath" : "../../../Packages/SC/patchers/sound/sc.scala",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "bach.filter.maxpat",
				"bootpath" : "Z:/Documents/Max 8/Packages/bach/patchers",
...
, 			{
				"name" : "sc.ioscbank~.maxpat",
				"bootpath" : "Z:/Documents/Max 8/Packages/SC/dev/sound/sc.isobank~",
				"patcherrelativepath" : "../../../Packages/SC/dev/sound/sc.isobank~",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
